                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Totol </th><td> {{ $payment->totol }} </td></tr><tr><th> User Id </th><td> {{ $payment->user_id }} </td></tr><tr><th> Remark </th><td> {{ $payment->remark }} </td></tr><tr><th> Paid At </th><td> {{ $payment->paid_at }} </td></tr><tr><th> Receipt </th><td> {{ $payment->receipt }} </td></tr>
                                </tbody>
                            </table>
                        </div>
