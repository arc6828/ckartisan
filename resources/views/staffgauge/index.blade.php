                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Latitudegauge</th><th>Longitudegauge</th><th>Addressgauge</th><th>Amphoe</th><th>District</th><th>Province</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($staffgauge as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->latitudegauge }}</td><td>{{ $item->longitudegauge }}</td><td>{{ $item->addressgauge }}</td><td>{{ $item->amphoe }}</td><td>{{ $item->district }}</td><td>{{ $item->province }}</td>
                                        <td>
