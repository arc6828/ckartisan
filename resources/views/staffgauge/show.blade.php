                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Latitudegauge </th><td> {{ $staffgauge->latitudegauge }} </td></tr><tr><th> Longitudegauge </th><td> {{ $staffgauge->longitudegauge }} </td></tr><tr><th> Addressgauge </th><td> {{ $staffgauge->addressgauge }} </td></tr><tr><th> Amphoe </th><td> {{ $staffgauge->amphoe }} </td></tr><tr><th> District </th><td> {{ $staffgauge->district }} </td></tr><tr><th> Province </th><td> {{ $staffgauge->province }} </td></tr>
                                </tbody>
                            </table>
                        </div>
