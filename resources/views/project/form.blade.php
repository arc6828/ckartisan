...
<div class="form-group {{ $errors->has('begin_date') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="begin_date" type="date" id="begin_date" value="{{ isset($project->begin_date) ? $project->begin_date : date('Y-m-d') }}" >
...
<div class="form-group {{ $errors->has('user_id') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="user_id" type="hidden" id="user_id" value="{{ isset($project->user_id) ? $project->user_id : Auth::id() }}" >
