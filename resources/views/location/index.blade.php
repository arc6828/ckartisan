                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Address</th><th>Latitude</th><th>Longitude</th><th>Typegroup</th><th>Lineid</th><th>Staffgaugeid</th><th>User Id</th><th>Msglocid</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($location as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->address }}</td><td>{{ $item->latitude }}</td><td>{{ $item->longitude }}</td><td>{{ $item->typegroup }}</td><td>{{ $item->lineid }}</td><td>{{ $item->staffgaugeid }}</td><td>{{ $item->user_id }}</td><td>{{ $item->msglocid }}</td>
                                        <td>
